...
public class AdminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "EEE", "EC", "CS", "IT" }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            st.executeUpdate("insert into student(roll,course,branchName,gender,fatherName,name)Values('"+roll+"','"+course+"','"+branchName+"','"+gender+"','"+fatherName+"','"+name+"')");
